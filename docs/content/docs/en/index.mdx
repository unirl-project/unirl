...
```bash
python -m unirl.train_diffusion       --config-name=<recipe-path>  # diffusion image/video
python -m unirl.train_ar              --config-name=<recipe-path>  # autoregressive/VLM RL
python -m unirl.train_sft             --config-name=<recipe-path>  # supervised fine-tuning
python -m unirl.train_async_ar        --config-name=<recipe-path>  # asynchronous AR RL
python -m unirl.train_async_diffusion --config-name=<recipe-path>  # asynchronous diffusion RL
python -m unirl.train_pe              --config-name=<recipe-path>  # prompt enhancement
python -m unirl.train_unified_model   --config-name=<recipe-path>  # mixed AR + diffusion
